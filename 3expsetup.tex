...
Deposition times presented in \autoref{tab:expsetup:mol-dep} vary depending on the desired coverage. The times listed are for sparse coverages. The deposition may be repeated multiple times until coverage is sufficient. 
