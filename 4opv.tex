...
There are significantly fewer \ac{STML} studies of PTCDA when compared to ZnPc, references \citep{Rzeznicka2011} and \citep{Kimura2019}. In the former, \textit{Rzeznicka et al.} study bilayers of PTCDA on Au(111), with the first monolayer acting as the decoupling layer. The authors reported an emission peak at \SI{1.8}{eV}, and another at \SI{2.35}{eV}, with a tip-sample bias of \SI{3}{V}. 


In the former, \textit{Kimura et al.} study single negatively charged PTCDA on (3ML)NaCl/Ag(111), detecting a sharp emission peak at \SI{2.45}{eV} with bias \SI{-3.4}{V}, which the authors have attributed to the 0-0 $S_1\rightarrow S_0$ transition. This peak was not observed in our experiment, possibly due to the lack of plasmonic enhancement in that region of the spectrum. 
